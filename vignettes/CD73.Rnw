...
All \Sexpr{nrow(nt5e.survival.data)} samples in the pooled dataset had expression levels for CD73. CD73 expression levels were separated into tertiles, and below is a survival curve for the pooled dataset. The p-value is for the likelihood ratio test, and the d- and c-indices were generated by setting risk as positively associated with expression level - \textit{i.e.}, higher expression, higher risk.
\begin{figure}[H]
...
survcomp::forestplot.surv(labeltext=d.labeltext, mean=d.indices, lower=d.lower, upper=d.upper, zero=1, xlab="d-index")
@
...
survcomp::forestplot.surv(labeltext=labeltext, mean=c.indices, lower=c.lower, upper=c.upper, zero=0.5, xlab="c-index")
@
\end{document}