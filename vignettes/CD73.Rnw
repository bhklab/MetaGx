...
.getPooledEset <- function(only.hgs=TRUE) {
  ...
  eset.toreturn$Bentink.subtypes <- as.factor(eset.toreturn$Bentink.subtypes)
...
\begin{figure}[H]
<<NT5E_load_data, eval=TRUE, fig.width=6.75, fig.height=8, out.width="0.6\\textwidth">>=
...
<<NT5E_survival, eval=TRUE, fig.width=6.75, fig.height=8, out.width="0.6\\textwidth">>=
create.survival.plot(
  ...
  strata.names=paste("NT5E", gsub(".*=", "",levels(nt5e.survival.data$NT5E.quantile))),
...
\begin{figure}[H]
<<CD73_survival_verhaak_subtypes, eval=TRUE, fig.width=6.75, fig.height=8, out.width="0.6\\textwidth">>=
par(mfrow=c(2,2))
...
\begin{figure}[H]
<<CD73_survival_bentink_subtypes, eval=TRUE, fig.width=6.75, fig.height=8, out.width="0.6\\textwidth">>=
par(mfrow=c(1,2))
