...
<<Single_gene_dataset_table_{{current.index}}, results='asis', include=TRUE, fig.width=12, fig.height=6, out.width="0.8\\textwidth">>=
...
par(mfrow=c(1,2))
if("METABRIC" %in% survival.df$data.source) {
