...
Treatment status may be a confounder to patient outcome. We performed survival analysis on only untreated patients:\footnote{Datasets with fewer than 50 untreated patients were excluded.}
