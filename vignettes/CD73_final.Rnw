...
pair.survival.data.poolfirst$Double.high.expression <- factor(pair.survival.data.poolfirst$NT5E.quantile == "High" & pair.survival.data.poolfirst$ENTPD1.quantile == "High", levels=c("FALSE", "TRUE"), ordered=TRUE)
...
<<NT5E_upper_vs_lower_poolfirst, fig.width=6.75, fig.height=8, out.width="0.8\\textwidth">>=
pair.survival.data.poolfirst <- .get.survival.data.for.plotting(pooled.eset, gene.name=c("NT5E", "ENTPD1"), num.quantiles=2, survival.type="overall.survival", time.unit="years")
pair.survival.data.poolfirst$Double.low.expression <- factor(pair.survival.data.poolfirst$NT5E.quantile == "Low" & pair.survival.data.poolfirst$ENTPD1.quantile == "Low", levels=c("FALSE", "TRUE"), ordered=TRUE)
