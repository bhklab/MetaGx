...
png("subtype_classifier_conting_fours.png", width=1400, height=400)
do.call(grid.arrange, c(contingency.plots[1:3], ncol = 3))
dev.off()
png("subtype_classifier_conting_bentink.png", width=1400, height=220)
do.call(grid.arrange, c(contingency.plots[4:6], ncol = 3))
dev.off()
@

<<Pooled.survival>>=
png("pooled_survival.png", width=2400, height=2000)
par(mfrow=c(2,2))
par(mar=c(5,1,0,1))
