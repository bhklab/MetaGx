...
<<TCGA_pred_str, out.width="0.7\\textwidth">>=
...
<<TCGA_pred_str_scatter, out.width="0.7\\textwidth">>=
...
<<Tothill_pred_str, out.width="0.7\\textwidth">>=
...
\pagebreak
Prediction strength vs the number of patients in each dataset:
<<Tothill_pred_str_scatter, out.width="0.7\\textwidth">>=
...
<<Konecny_pred_str, out.width="0.7\\textwidth">>=
...
\pagebreak
Prediction strength vs the number of patients in each dataset:
<<Konecny_pred_str_scatter, out.width="0.7\\textwidth">>=
